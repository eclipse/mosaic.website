...
In order for your scenario to enable the SNS follow the steps [here]({{< ref "docs/building_scenarios/scenario_configuration.md#communication-simulators-cell2-ns3-omnetpp-sns" >}}).
