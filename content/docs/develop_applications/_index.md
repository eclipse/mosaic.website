...
Applications in Eclipse MOSAIC are simulated by the [Application Simulator]({{< ref "/docs/simulators/application_simulator" >}}). Such 
...
a vehicle (or RSU, or traffic light, ...) via the mapping configuration (see section [mapping]({{< ref "/docs/building_scenarios#applications-and-mapping" >}})). Finally,
...
The navigation of vehicles (i.e. calculation of routes) is handled completely by the [Application Simulator]({{< ref "/docs/simulators/application_simulator#eclipse-mosaic-application-simulator" >}}). Each vehicle is equipped
