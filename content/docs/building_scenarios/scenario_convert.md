...
We will be using {{< link title="steglitz.osm" href="/docs/building_scenarios/files/steglitz.osm" >}} OSM-file for most of the
...
{{% alert note %}}
 {{< link title="Here" href=#reference-documentation-for-scenario-convert" >}} you can find a complete reference to all options scenario-convert offers. 
{{% /alert %}}
...
```
See {{< link title="below" href="#reference-documentation-for-scenario-convert" >}} for all command line options.
...
please have a look {{< link title="here (Simulation Scenarios)" href="/docs/building_scenarios/" >}} and 
{{< link title="here (Application Development)" href="/docs/develop_applications/" >}}.  
...
{{< link title="here" href="/docs/building_scenarios/files/steglitz.rou.xml" >}}. We'll start with only the `steglitz.osm` and 
...
- {{< link title="Steglitz OSM-file" href="/docs/building_scenarios/files/steglitz.osm" >}}
- {{< link title="Steglitz Route-file" href="/docs/building_scenarios/files/steglitz.rou.xml" >}}
