...
{{< link title="here" href="docs/simulators/application_simulator#configuration" >}}.
...
More information on the mapping configuration can be found ({{< link title="here" href="docs/simulators/application_simulator#configuration" >}}.
...
is usually generated by the tool `scenario-convert`, which is described {{< link title="here" href="docs/building_scenarios/scenario_convert" >}} in detail.
...
most of the required files can be extracted from other scenarios, such {{< link title="Barnim" href="tutorials/barnim_basic" >}} or
{{< link title="Tiergarten" href="tutorials/tiergarten" >}}. 
...
<br>{{< link title="Eclipse MOSAIC SNS" href="docs/simulators/network_simulator_sns" >}}
<br>{{< link title="Eclipse MOSAIC Cell" href="docs/simulators/network_simulator_cell" >}}
<br>{{< link title="OMNeT++" href="docs/simulators/network_simulator_omnetpp" >}}
<br>{{< link title="ns-3" href="docs/simulators/network_simulator_ns3" >}}
